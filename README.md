...
2.Routing
Routing is the process of creating copper tracks on the PCB to electrically connect components according to the schematic.

3️.Reference Designator
A reference designator (such as R1, C1, U1) uniquely identifies each component on the PCB and schematic, helping in assembly, debugging, and documentation.
